...
<div class="fonts-title"><div class="text-wrapper">Cart</div></div>
<div class="frame">
    <div class="div">
        <div class="fonts-table">
            <div class="text-wrapper">Product details</div>
            <div class="text-wrapper-2">Quanity</div>
        ...
        <div class="frame-wrapper">
            <div class="div-2">
                <div class="div-2">
                    <div class="ui-image"><img class="replace" src="{{ Vite::asset('storage/app/public/' . $product->image) }}" alt="image"/></div>
                    <div class="fonts-subtitle">
                        <p class="apple-iphone-pro">{{ $product->name }}</p>
                        <div class="div-4">
                            <div class="text">
                                <div class="text-wrapper-6">ID:{{ $product->code }}</div>
                                <div class="rectangle-3"></div>
                                <div class="div-wrapper"><div class="text-wrapper-7">In Stock</div></div>
                            </div>
                            <div class="text"><div class="text-wrapper-6">{{ $product->price }}</div></div>
                        </div>
                    </div>
                </div>
                <div class="UI-counter-wrapper">
    ...
    <div class="div-5">
        <div class="div-6">
            <div class="fonts-title"><div class="text-wrapper-8">Total</div></div>
            <div class="div-7">
                <div class="div-8">
                    <div class="text-wrapper-9">Subtotal</div>
                    <div class="text-wrapper-10">${{ $order->getFullPrice() }}</div>
                </div>
                <div class="div-8">
                    <div class="text-wrapper-9">Estimated Shipping</div>
                    <div class="text-wrapper-10">Free</div>
                </div>
            </div>
            <div class="rectangle-4"></div>
            <div class="div-8">
                <div class="text-wrapper-11">Order Total</div>
                <div class="text-wrapper-12">${{ $order->getFullPrice() }}</div>
            </div>
            <div class="div-9">
                <div class="div-wrapper-2"><div class="btn text-wrapper-13" >
        ...
        <div class="div-9">
            <div class="text-wrapper-15">Payment methods:</div>
